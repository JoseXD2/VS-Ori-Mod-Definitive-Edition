...
class ExtraSongState extends MusicBeatState
{
    ...
    override function create() 
	{
		...
		addWeek(['Tutorial', 'Spirit-Tree-Old', 'OG-Restoring-The-Light', 'Decay', 'Trirotation'], 1, ['gf', 'ori', 'ori', 'shriek', 'evilori']);
        addWeek(['Think', 'Corrupurgation', 'Expurgation'], 1, ['finn', 'arzo', 'arzo-old']);
...
class ExtraSongState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if PRELOAD_ALL
		var leText:String = "Press SPACE to listen to the Instrumental / Press Enter to listen to the full track.";
		var size:Int = 18;
		#else
		var leText:String = "";
		var size:Int = 20;
	...
	//	}
		...
		/*		LoadingState.loadAndSwitchState(new ChartingState());
			...
			//	LoadingState.loadAndSwitchState(new PlayState());
				if (songLowercase != 'starbucks' || songLowercase != 'think' || songLowercase != 'reality-breaking' || songLowercase != 'og-restoring-the-light' || songLowercase != 'trirotation')
				LoadingState.loadAndSwitchState(new CharacterSelectState()); // FUCK YOU PSYCH ENGINE, LET ME DO WHATEVER I FUCKING WANT YOU FUCKING BITCH. GO FUCKING DIE YOU PIECE OF GARBAGE!!! >:(
				else
				LoadingState.loadAndSwitchState(new PlayState());
