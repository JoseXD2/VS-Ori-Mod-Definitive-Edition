...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['changeicon', "(WIP)\nChanges the icon to whatever, i totally didn't\nsteal this from starlight mayhem, fuck me.\nValue 1 is p1 (bf) or p2 (opponent)\nwhile vaule 2 is whatever icon you set."],
	];
	...
	**/
	...
	function loadJson(song:String):Void
	{
		...
		if (CoolUtil.difficulties[PlayState.storyDifficulty] != "Standered"){
