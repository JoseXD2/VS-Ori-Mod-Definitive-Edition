...
class CharacterWarnSubState extends MusicBeatSubstate
{
	var bg:FlxSprite;
	...
	public function new(song:String, difficulty:Int, character:String, week:Int = -1)
	{
		...
		var text:Alphabet = new Alphabet(0, 130, "Warning This Song uses\nA Custom Boyfriend\nor different varient of boyfriend.\nContinue to Character Selection?", true);
		text.screenCenter(X);
