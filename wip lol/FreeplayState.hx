...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		addSong('Practice', 0, 'ori', Std.parseInt('0xFFFFFFFF'), 100);
		addSong('Spirit Tree', 1, 'ori', Std.parseInt('0xFFFFFFFF'), 110);
		addSong('Restoring The Light', 1, 'ori', Std.parseInt('0xFFFFFFFF'), 160);
		addSong('Horu', 2, 'ori', Std.parseInt('0xFFAAA3FF'), 0);
		addSong('Fleeing', 2, 'kuro', Std.parseInt('0xFFAAA3FF'), 0);
		addSong('Light', 2, 'light', Std.parseInt('0xFFAAA3FF'), 0);
		addSong('Trirotation', 3, 'evilori', Std.parseInt('0xFFFF7777'), 144);
		addSong('Shrieker', 4, 'shriek', Std.parseInt('0xFFB25BFF'), 0);
		addSong('Decay', 4, 'shriek', Std.parseInt('0xFFB25BFF'), 197);
		addSong('Test', 6, 'shriek', Std.parseInt('0xFF5E96FF'), 150);
		addSong('Blind Forest', 5, 'shriek', Std.parseInt('0xFFFF0000'), 230);
	...
	//	}
		...
		if (curSelected == 8 && curDifficulty == 0)
			songDiff.animation.play('normal', true);
		if (curSelected == 8 && curDifficulty == 1)
			songDiff.animation.play('hard', true);
		if (curSelected == 9)
			songDiff.animation.play('normal', true);
		if (curSelected == 3 && curDifficulty == 0)
			songDiff.animation.play('hard', true);
		if (curSelected == 3 && curDifficulty == 1)
			songDiff.animation.play('extreme', true);
		if (curSelected == 3 && curDifficulty == 2)
			songDiff.animation.play('easy', true);
		if (curSelected == 10)
			songDiff.animation.play('extreme', true);
		if (curSelected == 4 || curSelected == 5 || curSelected == 6 || curSelected == 7)
			songDiff.animation.play('auto', true);

		if (curSelected == 0 || curSelected == 9)
			diffText.alpha = 0;
		else
			diffText.alpha = 1;
	...
	function changeDiff(change:Int = 0)
	{
		...
		if(sprDifficulty.graphic != newImage)
		{
			...
			tweenDifficulty = FlxTween.tween(sprDifficulty, {y: scoreText.y + 100, alpha: 1}, 0.07, {onComplete: function(twn:FlxTween)
			{
	...
	public function getSongData()
		{
			var allData:Array<Dynamic> = [songs[curSelected].songName, songs[curSelected].week, songs[curSelected].songCharacter, songs[curSelected].color, songs[curSelected].bpm];
	...
	function changeSelection(change:Int = 0, playSound:Bool = true)
	{
		...
		if (curSelected == 4 || curSelected == 5 || curSelected == 6 || curSelected == 7 || curSelected == 10) {
			// do nothing
		}
		else {
