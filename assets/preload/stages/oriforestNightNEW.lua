function onCreate()
	...
	makeLuaSprite('tree','nibel/v5/tree dark',x+700,y+50)
	...
	makeLuaSprite('bushes','nibel/v5/bushes dark',x,y+500)
	setProperty('bushes.scale.x', 2);
	setProperty('bushes.scale.y', 2);

	makeLuaSprite('grass','nibel/v5/gss-dark',x,y+100)
...
function onCreatePost()
	...
	doTweenColor('gangColorTween', 'gang', colorchange, 0.01); --even though there is no gang for this stage lmfao
end